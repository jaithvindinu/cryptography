...
// String to hold the ciphertext (to be decrypted)
string ct;
...
// Function to perform a circular left shift by 1
...
// Function to perform a circular left shift by 2
...
{ 
    ...
    // The substitution boxes. They should contain values
    ...
    // The ciphertext is decrypted 16 times  
    for(int i = 0; i < 16; i++) { 
        string right_expanded = ""; 
        // 3.1. The right half of the ciphertext is expanded
        for(int i = 0; i < 48; i++) { 
        ...
        // 3.7. The left and the right parts of the ciphertext are swapped 
        left = xored; 
        if(i < 15){ 
            string temp = right;
            right = xored;
    ...
    // 4. The halves of the ciphertext are applied
    string combined_text = left + right;   
    string decrypted_text = ""; 
    // The inverse of the initial permutation is applied
    for(int i = 0; i < 64; i++){ 
        decrypted_text += combined_text[inverse_permutation[i]-1]; 
    }
...
int main(){ 
    // A 64-bit key (binary format)
    string key;
    // Taking the key and ciphertext as user inputs
    cout << "Enter the 64-bit key (in binary format): ";
    cin >> key;
    cout << "Enter the 64-bit ciphertext (in binary format): ";
    cin >> ct;
    ...
    string decrypted_text = DES_decrypt();
